    ...
    <main>
      ...
      <div class="container flex flex-col lg:flex-row items-center py-20 gap-10">
        <div class="flex-1 order-2 lg:order-1 text-center lg:text-left">
          ...
          <button class="px-4 py-2 text-white self-start bg-black rounded-md text-lg cursor-pointer">
            Browse Recipes
          </button>
        </div>
      ...
      <div  class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-8">
        <div v-for="recipe in data?.recipes"  class="flex flex-col shadow rounded-md">
          ...
          <div class="flex flex-col py-6 px-4 flex-1">
            ...
            <button class="px-4 py-2 text-black self-start bg-amber-600 rounded-md text-base lg:text-lg cursor-pointer">
              View
            </button>
          </div>
        </div>
